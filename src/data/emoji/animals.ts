...
export const ANIMAL_EMOJI_PUZZLES: EmojiPuzzle[] = [
  {
    ...
    en: {
      answer: 'Kangaroo',
      options: ['Kangaroo', 'Koala', 'Wombat', 'Wallaby'],
    ...
    fr: {
      answer: 'Kangourou',
      options: ['Kangourou', 'Koala', 'Wombat', 'Wallaby'],
      explanation: 'Marsupial emblématique d\'Australie célèbre pour ses grands bonds et la poche ventrale où grandit son petit.',
    },
  },
  {
    id: 'an-2',
    ...
    fr: {
      answer: 'Panda géant',
      options: ['Panda géant', 'Panda roux', 'Ours polaire', 'Ours malais'],
      explanation: 'Trésor national de Chine au pelage noir et blanc caractéristique qui se nourrit presque exclusivement de bambou.',
    },
  },
  {
    id: 'an-3',
    ...
    fr: {
      answer: 'Caméléon',
      options: ['Caméléon', 'Gecko', 'Iguane', 'Dragon de Komodo'],
      explanation: 'Reptile fascinant capable de changer de couleur, doté d\'yeux indépendants et d\'une langue ultra-rapide.',
    },
  },
  {
    id: 'an-4',
  ...
  },
  {
    ...
    en: {
      answer: 'Cheetah',
      options: ['Cheetah', 'Leopard', 'Jaguar', 'Tiger'],
    ...
    fr: {
      answer: 'Guépard',
      options: ['Guépard', 'Léopard', 'Jaguar', 'Tigre'],
      explanation: 'L\'animal terrestre le plus rapide du monde, capable d\'atteindre 100 km/h en seulement trois secondes.',
    },
  },
  {
    id: 'an-6',
    ...
    en: {
      answer: 'Sloth',
      options: ['Sloth', 'Koala', 'Anteater', 'Armadillo'],
    ...
    fr: {
      answer: 'Paresseux',
      options: ['Paresseux', 'Koala', 'Tamanoir', 'Tatou'],
      explanation: 'Mammifère arboricole des forêts tropicales réputé pour sa lenteur extrême et sa vie suspendue aux branches.',
    },
  },
  {
    id: 'an-7',
    ...
    fr: {
      answer: 'Flamant rose',
      options: ['Flamant rose', 'Cigogne', 'Pélican', 'Grue'],
      explanation: 'Grand échassier au plumage rose éclatant dû à son alimentation en crevettes et algues, souvent perché sur une patte.',
    },
  },
  {
    id: 'an-8',
    ...
    en: {
      answer: 'Beaver',
      options: ['Beaver', 'Otter', 'Platypus', 'Capybara'],
    ...
    fr: {
      answer: 'Castor',
      options: ['Castor', 'Loutre', 'Ornithorynque', 'Capybara'],
      explanation: 'Rongeur bâtisseur réputé pour abattre des arbres et construire des barrages et des huttes sur les cours d\'eau.',
    },
  },
];
