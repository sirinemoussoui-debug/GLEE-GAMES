...
export const FOOD_EMOJI_PUZZLES: EmojiPuzzle[] = [
  {
    id: 'fd-1',
    emojis: '🍕🧀🍅🔥🇮🇹',
    category: 'food',
    ...
    en: {
      ...
      options: ['Pizza Margherita', 'Calzone', 'Lasagna', 'Focaccia'],
    ...
    fr: {
      answer: 'Pizza Margherita',
      options: ['Pizza Margherita', 'Calzone', 'Lasagne', 'Focaccia'],
      explanation: 'La pizza napolitaine classique aux couleurs du drapeau italien : sauce tomate, mozzarella et basilic frais.',
    },
  },
  {
    id: 'fd-2',
    ...
    difficulty: 'easy',
    en: {
      answer: 'Sushi & Sashimi',
      options: ['Sushi & Sashimi', 'Ramen', 'Tempura', 'Gyoza'],
    ...
    fr: {
      answer: 'Sushi & Sashimi',
      options: ['Sushi & Sashimi', 'Ramen', 'Tempura', 'Gyoza'],
      explanation: 'Spécialité japonaise incontournable à base de riz vinaigré et de poissons crus frais dégustée avec des baguettes.',
    },
  },
  {
    id: 'fd-3',
    ...
    en: {
      answer: 'Croissant',
      options: ['Croissant', 'Baguette', 'Pain au chocolat', 'Brioche'],
    ...
    fr: {
      answer: 'Croissant au beurre',
      options: ['Croissant au beurre', 'Baguette', 'Pain au chocolat', 'Brioche'],
      explanation: 'Viennoiserie feuilletée emblématique du petit-déjeuner français préparée avec du bon beurre.',
    },
  },
  {
    id: 'fd-4',
  ...
  },
  {
    ...
    en: {
      answer: 'Couscous',
      options: ['Couscous', 'Tagine', 'Chakhchoukha', 'Harira'],
