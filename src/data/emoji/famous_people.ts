...
export const FAMOUS_PEOPLE_EMOJI_PUZZLES: EmojiPuzzle[] = [
  {
    id: 'fp-1',
    emojis: '🧠⚛️👅💡👴',
    ...
    fr: {
      answer: 'Albert Einstein',
      options: ['Albert Einstein', 'Isaac Newton', 'Nikola Tesla', 'Stephen Hawking'],
      explanation: 'Le physicien théoricien à l\'origine de la théorie de la relativité et de l\'équation E=mc².',
    },
  },
  {
    id: 'fp-2',
    ...
    fr: {
      answer: 'Isaac Newton',
      options: ['Isaac Newton', 'Galilée', 'Albert Einstein', 'Kepler'],
      explanation: 'Le savant qui a formulé les lois du mouvement et de la gravitation universelle après la chute d\'une pomme.',
    },
  },
  {
    id: 'fp-3',
  ...
  },
  {
    ...
    fr: {
      answer: 'Nikola Tesla',
      options: ['Nikola Tesla', 'Thomas Edison', 'Graham Bell', 'Faraday'],
      explanation: 'L\'inventeur de génie qui a développé le système électrique à courant alternatif (AC).',
    },
  },
  {
    id: 'fp-5',
    ...
    fr: {
      ...
      explanation: 'Le cofondateur visionnaire d\'Apple qui a révolutionné l\'informatique et les smartphones avec l\'iPhone.',
    },
  },
  {
    id: 'fp-6',
    ...
    fr: {
      answer: 'Elon Musk',
      options: ['Elon Musk', 'Jeff Bezos', 'Steve Jobs', 'Bill Gates'],
      explanation: 'Le patron de Tesla et SpaceX qui a popularisé les voitures électriques et les fusées réutilisables.',
    },
  },
  {
    id: 'fp-7',
    ...
    fr: {
      answer: 'Neil Armstrong',
      options: ['Neil Armstrong', 'Buzz Aldrin', 'Youri Gagarine', 'Thomas Pesquet'],
      explanation: 'Le premier être humain à avoir marché sur la Lune lors de la mission Apollo 11 en juillet 1969.',
    },
  },
  {
    id: 'fp-8',
    ...
    en: {
      answer: 'Cleopatra',
      options: ['Cleopatra', 'Nefertiti', 'Hatshepsut', 'Catherine the Great'],
